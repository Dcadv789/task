...
export const generateMockData = () => {
  ...
  const tasks: Task[] = [
    ...
    {
      id: 'task-4',
      title: 'Preparar slides iniciais',
      description: 'Montar slides com os principais pontos',
      completed: true,
      priority: 'média',
      dueDate: new Date().toISOString(),
    ...
    {
      id: 'task-5',
      title: 'Definir cronograma do projeto',
      description: 'Criar cronograma detalhado com todas as etapas',
      completed: false,
      priority: 'alta',
